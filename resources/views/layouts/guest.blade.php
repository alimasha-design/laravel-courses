...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
                ...
                <div class="flex h-16 justify-between items-center">
                    ...
                    <div class="flex items-center">
                        @if(Auth::check())
                            ...
                            @if(Auth::user()->type === 1)<a href="{{route('dashboard')}}" class="ml-8 inline-flex items-center justify-center rounded border border-transparent bg-black                                px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-red-500">Dashboard</a>
        ...
        <footer class="w-full bg-dark pt-[94px] relative">
            <div class="container">
                <img src="{{asset('img/footer-element.png')}}" alt="Stylish Design" class="w-auto h-auto object-contain absolute bottom-0 right-0 pointer-events-none z-10">
